...
import ru.panyukovnn.videoretellingbot.property.TgBotProperties;
...
public class TgBotConfig {
    ...
    @Bean
    public TgBotApi botApi(ApplicationEventPublisher eventPublisher, TgBotProperties botProperties, List<BotCommand> commands) throws TelegramApiException {
